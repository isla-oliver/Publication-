...
fig1c=ggplot(gib%>%filter(Location=='SR '))+
  geom_histogram(col='black', fill = "#C71000B2", aes(x=Length), binwidth = 31)+
  ylim(0,60)+xlim(100,500)+
  theme_classic()+theme(axis.title.y = element_blank())+
  xlab('Fork Length (mm)')+ ggtitle("Scott Reefs") + theme(plot.title = element_text(vjust = -5))+ 
...
fig3c=ggplot(gib%>%filter(Location=='Chagos '))+
  geom_histogram(col='black', fill = "#FF6F00B2", aes(x=Length), binwidth = 31)+
  ylim(0,60)+xlim(100,500)+
  theme_classic()+theme(axis.title.y = element_blank())+
  xlab('Fork Length (mm)')+ ggtitle("Chagos") + theme(plot.title = element_text(vjust = -5))+ 
  theme(plot.title = element_text(hjust = 0.1))
fig3c
...
fig4c=ggplot(gib%>%filter(Location=='Maldives '))+
  geom_histogram(col='black',fill = "#8A4198B2", aes(x=Length), binwidth = 31)+
  ylim(0,60)+xlim(100,500)+
  theme_classic()+theme(axis.title.y = element_blank())+
  xlab('Fork Length (mm)')+ ggtitle("Maldives") + theme(plot.title = element_text(vjust = -5))+ 
  theme(plot.title = element_text(hjust = 0.1))
fig4c
...
fig3N <- annotate_figure(fig3, 
               fig.lab = "L. gibbus", fig.lab.face = "italic", fig.lab.size = 16)
